...
export default {
  ...
  methods: {
    ...
    init () {
      ...
      textureFolder.add(texture2, 'minFilter', options.minFilters).onChange(() => this.updateMinFilter())
      textureFolder.add(texture2, 'magFilter', options.magFilters).onChange(() => this.updateMagFilter())
      textureFolder.open()
